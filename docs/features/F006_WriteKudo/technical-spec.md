...
| FR-008 | Hashtag * — label + "+ Hashtag" button (note "Tối đa 5"); adds chips; each chip has an `x` to remove; max 5 (button hidden/disabled at 5); required (≥1) | `HashtagField` | yes |
