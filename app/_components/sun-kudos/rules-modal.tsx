        ...
        >
          ...
          <section className="flex flex-col gap-4">
            <h3 className="text-lg font-bold uppercase leading-7 text-[#ffea9e] sm:text-[22px]">
              {RULES_COPY.receiversHeading}
            </h3>
            <p className="text-sm font-medium text-white sm:text-base">{RULES_COPY.receiversIntro}</p>
          ...
          <section className="flex flex-col gap-4">
            <h3 className="text-lg font-bold uppercase leading-7 text-[#ffea9e] sm:text-[22px]">
              {RULES_COPY.sendersHeading}
            </h3>
            <p className="text-sm font-medium text-white sm:text-base">{RULES_COPY.sendersIntro}</p>
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              {RULE_ICONS.map((icon) => (
                <IconTile key={icon.name} icon={icon} />
              ))}
            </div>
            <p className="text-sm font-medium text-white">{RULES_COPY.iconsNote}</p>
          </section>

          <section className="flex flex-col gap-4">
            <h3 className="text-xl font-bold uppercase leading-8 text-[#ffea9e] sm:text-2xl">
              {RULES_COPY.nationalHeading}
            </h3>
            <p className="text-sm font-medium text-white sm:text-base">{RULES_COPY.nationalCopy}</p>
          </section>
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <div className="flex flex-col gap-1">
        <p className="text-sm font-bold text-[#ffea9e]">{tier.countLabel}</p>
        <p className="text-sm font-medium text-white">{tier.description}</p>
      </div>
    </div>
  );
}
